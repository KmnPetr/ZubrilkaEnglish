...
export async function updateUsedLanguagesField(videoInfo_uuid, listLang) {
    try {
        const response = await api.patch('/api/video-info/update_list_used_lang',
            listLang,
            {
            params: { videoInfo_uuid }
        });
