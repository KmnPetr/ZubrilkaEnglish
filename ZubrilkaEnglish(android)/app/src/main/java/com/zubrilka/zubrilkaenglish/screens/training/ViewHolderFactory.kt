...
import com.zubrilka.zubrilkaenglish.databinding.ViewFewCardsBinding
import com.zubrilka.zubrilkaenglish.databinding.ViewNoMemosCardsBinding
import com.zubrilka.zubrilkaenglish.databinding.ViewReviewCardBinding
import com.zubrilka.zubrilkaenglish.databinding.ViewWordCard2mBinding
import com.zubrilka.zubrilkaenglish.databinding.ViewWordCardBinding
...
import com.zubrilka.zubrilkaenglish.events.StatEvEnum
import com.zubrilka.zubrilkaenglish.events.StatisticsEvent
import com.zubrilka.zubrilkaenglish.models.WordCard
import com.zubrilka.zubrilkaenglish.screens.training.additionalCards.FewCards
import com.zubrilka.zubrilkaenglish.screens.training.additionalCards.NoMemosCard
import com.zubrilka.zubrilkaenglish.screens.training.additionalCards.ReviewCard
import com.zubrilka.zubrilkaenglish.services.VibrationHandler
import com.zubrilka.zubrilkaenglish.utils.StatProgress
import com.zubrilka.zubrilkaenglish.utils.ui.CustButton
...
class ViewHolderFactory {
    class WordCardHolder(item: View): RecyclerView.ViewHolder(item){
        ...
        fun bind(wordCard: WordCard, listener: CardAdapter.Listener,position:Int){
            ...
            //настроим кнопку повторной озвучки
            if (!wordCard.word.link_voice.isNullOrEmpty()){
                binding.soundButton.isEnabled = true
                binding.soundButton.setupDrawable(R.drawable.sound)
                binding.soundButton.setOnClickListener {
                    listener.playVoice(wordCard)
                }
            } else {
                binding.soundButton.isEnabled = false
                binding.soundButton.setupDrawable(R.drawable.sound_absence)
            }
