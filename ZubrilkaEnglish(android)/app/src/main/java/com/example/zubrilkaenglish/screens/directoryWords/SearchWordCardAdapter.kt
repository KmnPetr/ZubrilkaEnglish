...
class SearchWordCardAdapter(navController: NavController) : RecyclerView.Adapter<SearchWordCardAdapter.CardHolder>() {
    ...
    class CardHolder(view: View, navController: NavController) : RecyclerView.ViewHolder(view){
        ...
        init {
            view.setOnClickListener {
                ...
                navController.navigate(R.id.action_directoryWordsFragment_to_wordDetailsFragment)
            }
        }
