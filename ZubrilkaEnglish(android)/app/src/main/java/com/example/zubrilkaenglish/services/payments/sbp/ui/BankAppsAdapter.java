package com.example.zubrilkaenglish.services.payments.sbp.ui;
...
public class BankAppsAdapter extends RecyclerView.Adapter<BankAppsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.sbp_item_app, parent, false);
    ...
    public void setApps(List<ResolveInfo> apps) {
        this.apps = apps;
        Log.d("ZE_LOG","SetUp list apps: size: "+apps.size());
    }
