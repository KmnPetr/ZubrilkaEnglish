...
pole (geography)	[pəʊl]	полюс (напр. Северный полюс)
flow	[fləʊ]	поток
stream	[striːm]	поток
...
growth	[grəʊθ]	рост
cell	[sɛl]	клетка (биол.)
variety	[vəˈraɪəti]	разнообразие
evolution	[ˌiːvəˈluːʃən]	эволюция
fish	[fɪʃ]	рыба
egg	[ɛg]	яйцо
male (biol.)	[meɪl]	самец
female (biol.)	[ˈfiːmeɪl]	самка
wing	[wɪŋ]	крыло
...
brick	[brɪk]	кирпич
lead	[liːd]	свинец
chip	[ʧɪp]	осколок (кусочек)
substance	[ˈsʌbstəns]	вещество
iron	[ˈaɪən]	железо
mixture	[ˈmɪksʧə]	смесь
fiber	[faɪbə]	волокно
chemical	[ˈkɛmɪkəl]	химикат
tissue (biol.)	[ˈtɪʃuː]	ткань (биол.)
mix	[mɪks]	смесь
paper	[ˈpeɪpə]	бумага
piece (of something)	[piːs]	кусок чего-либо
bit (of something)	[bɪt]	частичка
...
area	[ˈeərɪə]	местность
side	[saɪd]	сторона
end	[ɛnd]	конец
center	[ˈsɛntə]	центр
absence	[ˈæbsəns]	отсутствие
presence	[ˈprɛzns]	наличие
corner	[ˈkɔːnə]	угол
...
approach	[əˈprəʊʧ]	подход (к чему-либо)
...
finding	[ˈfaɪndɪŋ]	находка, вывод
search	[sɜːʧ]	поиск
...
scene	[siːn]	сцена
stage	[steɪʤ]	сцена (место, где выступают актеры)
song	[sɒŋ]	песня
