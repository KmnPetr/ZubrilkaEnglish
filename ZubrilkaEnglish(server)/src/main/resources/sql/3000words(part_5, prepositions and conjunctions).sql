...
--     Пространство
    ...
    ('front','[ɪn frʌntnɒv]','перед, фасад','Пример: "in front of TV - перед телевизором"','Пространство'),
...
--     Пространство
    ...
    ('out','[aʊt ɒv]','наружу, за пределы(чего-то)','','Пространство'),
...
--     Разные предлоги
    ...
    ('because','[bɪˈkəz]','потому что, из-за','','Разные предлоги'),
