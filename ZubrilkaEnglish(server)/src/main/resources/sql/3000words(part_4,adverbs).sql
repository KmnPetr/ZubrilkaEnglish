...
ever	[ˈɛvə]	вечно
later	[ˈleɪtə]	позже
(one year) ago	[əˈgəʊ]	(один год) назад
early	[ˈɜːli]	рано
soon	[suːn]	скоро
...
just	[ʤʌst]	только что (всего лишь)
...
also	[ˈɔːlsəʊ]	также
else (something else)	[ɛls]	еще (что-нибудь еще)
more	[mɔː]	больше
much	[mʌʧ]	много
less	[lɛs]	меньше
all	[ɔːl]	все
once	[wʌns]	раз (однажды)
...
otherwise	[ˈʌðəwaɪz]	в противном случае
    ...
    посмотреть наречие too слишком